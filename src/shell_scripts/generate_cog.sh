...
# iterate
# Iterates over all tifs in a directory and applies a function to each
# Arguments:
#   $1: function to apply and its arguments
#   $2: directory with tifs
# Usage:
#   iterate generate_rgb_cog /path/to/tifs/directory
iterate() {
    local function=$1
    local directory=$2
